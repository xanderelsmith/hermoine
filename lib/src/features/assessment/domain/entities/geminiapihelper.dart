class GeminiSparkConfig {
  ...
  static String prompt(
          ...
          String? instructions}) =>
      'Extract key information from this  provided text $message  and generate a quiz in valid JSON format, adhering to the following structure:${quizSample.toString()}\n and these rules $rules, it should $questionNumber in number and have a difficulty of $difficulty, ${instructions != null ? 'follow these $instructions' : ''}';
}
